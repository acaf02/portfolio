...
export const EXPERIENCES = [
  {
    ...
    role: "Estágio",
    company:
      "Cartório Serviço de Registro Civil das Pessoas Naturais e Registros Especiais",
...
export const PUBLICATION = [
  ...
  {
    title:
      "StockManager: um software para controle de estoques alimentícios no refeitório do IFFAR - Campus Alegrete",
  ...
  {
    title:
      "CHEMICALL: Sistema de gestão de produtos químicos para laboratórios de Institutos Federais, um estudo de caso IFFarroupilha",
    publication: "XV Mostra da Educação Profissional e Tecnológica",
    url: "https://arandu.iffarroupilha.edu.br/handle/itemid/540",
    description:
      "Página: 785" +
...
export const ACADEMY = [
  ...
  },
  {
    ...
    description:
      "Iniciei minha jornada no aprendizado de idiomas, com o objetivo de expandir meus horizontes profissionais e pessoais, melhorando a comunicação em inglês para atuar no mercado global.",
  },
];
