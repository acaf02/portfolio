            ...
            >
                ...
                <div style={{ maxWidth: "400px", margin: "0 auto" }}>
                    <Carousel
                        ...
                        transitionTime={500}
                    >
                        {[SA1, SA2, SA3, SA4, SA5, SA6, SA7, SA8, SA9, SA10].map((image, index) => (
                            <div key={index}>
                ...
                <div style={{ maxWidth: "400px", margin: "0 auto" }}>
                    <Carousel
                        ...
                        transitionTime={500}
                    >
                        {[Divulgacao1, Divulgacao2, Divulgacao3, Divulgacao4, Divulgacao5, Divulgacao6].map((image, index) => (
                            <div key={index}>
                                <img src={image} alt={`Slide ${index + 1}`} />
                                <p className="legend">Divulgação do curso na 43° Feira do Livro de Alegrete</p>
                            </div>
                        ))}
                    </Carousel>
                </div>
